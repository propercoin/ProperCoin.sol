...
contract ProperCoin is Context, IERC20, Ownable {
    ...
    string public constant name = "Proper Coin";
    string public constant symbol = "PCP";
    uint8 public constant decimals = 10;
    
    uint256 public _taxFee = 5; // REFLECTION RATE
    uint256 public _liquidityFee = 5; // BURN RATE

    IUniswapV2Router public constant uniswapV2Router = IUniswapV2Router(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
    ...
    uint256 private immutable numTokensSellToAddToLiquidity = 100000 * 10**6 * 10**9;
